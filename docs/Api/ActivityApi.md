...
# **deleteActivity**
> \Model\ApiResponse deleteActivity($activity_id)
...
[**\Model\ActivityModel**](../Model/ActivityModel.md)
...
> \Model\ActivityListResponse retrieveListActivity($arguments)
...
$api_instance = new BumbalClient\Api\ActivityApi();
$arguments = new \Model\ActivityRetrieveListArguments(); // \Model\ActivityRetrieveListArguments | Activity RetrieveList Arguments
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\Model\ActivityRetrieveListArguments**](../Model/\Model\ActivityRetrieveListArguments.md)| Activity RetrieveList Arguments |

### Return type

[**\Model\ActivityListResponse**](../Model/ActivityListResponse.md)
...
# **setActivity**
> \Model\ApiResponse setActivity($body)
...
$api_instance = new BumbalClient\Api\ActivityApi();
$body = new \Model\ActivityModel(); // \Model\ActivityModel | Activity object
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Model\ActivityModel**](../Model/\Model\ActivityModel.md)| Activity object | [optional]
...
# **updateActivity**
> \Model\ApiResponse updateActivity($activity_id, $body)
...
$body = new \Model\ActivityModel(); // \Model\ActivityModel | Activity object that needs to be updated
 ...
 **body** | [**\Model\ActivityModel**](../Model/\Model\ActivityModel.md)| Activity object that needs to be updated | [optional]
