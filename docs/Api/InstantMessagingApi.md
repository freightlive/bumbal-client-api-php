...
$apiInstance = new BumbalClient\Api\InstantMessagingApi(
...
try {
    $result = $apiInstance->instantMessagingList();
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->instantMessagingPost();
    print_r($result);
} catch (Exception $e) {
...
try {
    $result = $apiInstance->instantMessagingRetrieveConversation();
    print_r($result);
} catch (Exception $e) {
