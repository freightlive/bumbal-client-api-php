...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\BumbalClient\Model\CapacityTypeRetrieveListArguments**](../Model/\BumbalClient\Model\CapacityTypeRetrieveListArguments.md)| CapacityType RetrieveList Arguments |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\BumbalClient\Model\CapacityTypeModel**](../Model/\BumbalClient\Model\CapacityTypeModel.md)| CapacityType model | [optional]
