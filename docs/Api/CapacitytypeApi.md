...
# **deleteCapacityType**
> \Model\ApiResponse deleteCapacityType($capacity_type_id)
...
> \Model\CapacityTypeModel retrieveCapacityType($capacity_type_id, $include_uom, $include_uom_group, $include_uom_name)
...
[**\Model\CapacityTypeModel**](../Model/CapacityTypeModel.md)
...
> \Model\CapacityTypeListResponse retrieveListCapacityType($arguments)
...
$api_instance = new BumbalClient\Api\CapacitytypeApi();
$arguments = new \Model\CapacityTypeRetrieveListArguments(); // \Model\CapacityTypeRetrieveListArguments | CapacityType RetrieveList Arguments
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\Model\CapacityTypeRetrieveListArguments**](../Model/\Model\CapacityTypeRetrieveListArguments.md)| CapacityType RetrieveList Arguments |

### Return type

[**\Model\CapacityTypeListResponse**](../Model/CapacityTypeListResponse.md)
...
# **setCapacityType**
> \Model\ApiResponse setCapacityType($body)
...
$api_instance = new BumbalClient\Api\CapacitytypeApi();
$body = new \Model\CapacityTypeModel(); // \Model\CapacityTypeModel | CapacityType model
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Model\CapacityTypeModel**](../Model/\Model\CapacityTypeModel.md)| CapacityType model | [optional]
