...
# **deleteRecurrence**
> \Model\ApiResponse deleteRecurrence($recurrence_id)
...
> \Model\RecurrenceModel[] retrieveListRecurrence($arguments)
...
$api_instance = new BumbalClient\Api\RecurrenceApi();
$arguments = new \Model\RecurrenceRetrieveListArguments(); // \Model\RecurrenceRetrieveListArguments | Recurrence RetrieveList Arguments
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\Model\RecurrenceRetrieveListArguments**](../Model/\Model\RecurrenceRetrieveListArguments.md)| Recurrence RetrieveList Arguments |

### Return type

[**\Model\RecurrenceModel[]**](../Model/RecurrenceModel.md)
...
# **retrieveRecurrence**
> \Model\RecurrenceModel retrieveRecurrence($recurrence_id)
...
# **updateRecurrence**
> \Model\ApiResponse updateRecurrence($recurrence_id)
