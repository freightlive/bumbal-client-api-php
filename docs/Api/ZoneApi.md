...
# **createZone**
> \Model\ApiResponse createZone($body)
...
$body = new \Model\ZoneModel(); // \Model\ZoneModel | Zone object that needs to be created
...
------------- | ------------- | ------------- | -------------
 **body** | [**\Model\ZoneModel**](../Model/\Model\ZoneModel.md)| Zone object that needs to be created | [optional]
...
# **deleteZone**
> \Model\ApiResponse deleteZone($zone_id)
...
# **retrieveListZone**
> \Model\ZoneModel[] retrieveListZone($arguments)
...
$api_instance = new BumbalClient\Api\ZoneApi();
$arguments = new \Model\ZoneRetrieveListArguments(); // \Model\ZoneRetrieveListArguments | Zone RetrieveList Arguments
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\Model\ZoneRetrieveListArguments**](../Model/\Model\ZoneRetrieveListArguments.md)| Zone RetrieveList Arguments |

### Return type

[**\Model\ZoneModel[]**](../Model/ZoneModel.md)
...
# **retrieveZone**
> \Model\ZoneModel retrieveZone($zone_id)
...
# **setZone**
> \Model\ApiResponse setZone($body)
...
$api_instance = new BumbalClient\Api\ZoneApi();
$body = new \Model\ZoneModel(); // \Model\ZoneModel | Zone object
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Model\ZoneModel**](../Model/\Model\ZoneModel.md)| Zone object | [optional]
...
# **updateZone**
> \Model\ApiResponse updateZone($zone_id)
