...
> \Model\ApiResponse saywhenRetrievePortalURL($activity_id)
...
> \Model\ApiResponse saywhenRetrievePortalURLs($arguments)
...
$api_instance = new BumbalClient\Api\SaywhenApi();
$arguments = new \Model\SayWhenRetrievePortalURLsArguments(); // \Model\SayWhenRetrievePortalURLsArguments | portal urls Arguments
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\Model\SayWhenRetrievePortalURLsArguments**](../Model/\Model\SayWhenRetrievePortalURLsArguments.md)| portal urls Arguments |
...
> \Model\SayWhenVisitModel saywhenRetrieveStatus($activity_id)
...
[**\Model\SayWhenVisitModel**](../Model/SayWhenVisitModel.md)
