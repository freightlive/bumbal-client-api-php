...
# **createNotification**
> \BumbalClient\Model\ApiResponse24 createNotification($body)
...
# **deleteNotification**
> \BumbalClient\Model\ApiResponse21 deleteNotification($notification_id)
...
# **updateNotification**
> \BumbalClient\Model\ApiResponse20 updateNotification($notification_id, $body)
