...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **arguments** | [**\BumbalClient\Model\AddressReverseGeoCodeArguments**](../Model/\BumbalClient\Model\AddressReverseGeoCodeArguments.md)| Address Reverse GeoCode Arguments |
