...
**driver_link** | [**\Model\LinkModel**](LinkModel.md) |  | [optional] 
**driver_links** | [**\Model\LinkModel[]**](LinkModel.md) |  | [optional] 
**driver** | [**\Model\UsersModel**](UsersModel.md) |  | [optional] 
**user_link** | [**\Model\LinkModel[]**](LinkModel.md) |  | [optional] 
**car_id** | **int** |  | [optional] 
**vehicle_id** | **int** | Bumbal internal id for vehicle associated with this route | [optional] 
**vehicle_link** | [**\Model\LinkModel[]**](LinkModel.md) | link object to identify a vehicle uniquely by an external id and provider name | [optional] 
**vehicle** | [**\Model\VehicleModel**](VehicleModel.md) | Vehicle object with the vehicle properties assigned to this route | [optional] 
**car_link** | [**\Model\LinkModel[]**](LinkModel.md) |  | [optional] 
**car** | [**\Model\VehicleModel**](VehicleModel.md) |  | [optional] 
**trailer_id** | **int** |  | [optional] 
**trailer_link** | [**\Model\LinkModel[]**](LinkModel.md) |  | [optional] 
...
**gps_locations** | [**\Model\GPSLocationModel[]**](GPSLocationModel.md) |  | [optional] 
**latest_known_position** | [**\Model\GPSLocationModel**](GPSLocationModel.md) |  | [optional] 
...
**start_address** | [**\Model\AddressModel**](AddressModel.md) |  | [optional] 
**end_address** | [**\Model\AddressModel**](AddressModel.md) |  | [optional] 
