...
- API version: 2.0
- Build date: 2019-10-23T13:18:42.450+02:00
...
*CompartmentApi* | [**deleteCompartment**](docs/Api/CompartmentApi.md#deletecompartment) | **DELETE** /compartment/{compartmentId} | Delete a compartment
*CompartmentApi* | [**retrieveCompartment**](docs/Api/CompartmentApi.md#retrievecompartment) | **GET** /compartment/{compartmentId} | Find compartment by ID
*CompartmentApi* | [**retrieveListCompartment**](docs/Api/CompartmentApi.md#retrievelistcompartment) | **PUT** /compartment | Retrieve List of Compartments
*CompartmentApi* | [**setCompartment**](docs/Api/CompartmentApi.md#setcompartment) | **POST** /compartment/set | Set (create or update) a Compartment
*CompartmentApi* | [**updateCompartment**](docs/Api/CompartmentApi.md#updatecompartment) | **PUT** /compartment/{compartmentId} | Update a compartment
