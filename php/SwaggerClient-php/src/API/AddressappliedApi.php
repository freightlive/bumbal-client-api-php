...
class AddressappliedApi
{
     ...
     * @return \Bumbal\Client\Model\AddressAppliedModel
     */
     ...
     * @param int $address_id ID of the applied address to retrieve (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return array of \Bumbal\Client\Model\AddressAppliedModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveAddressAppliedWithHttpInfo($address_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Bumbal\Client\Model\AddressAppliedModel',
                '/address-applied/{addressId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Bumbal\Client\Model\AddressAppliedModel', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Bumbal\Client\Model\AddressAppliedModel', $e->getResponseHeaders());
