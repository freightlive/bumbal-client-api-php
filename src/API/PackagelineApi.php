...
class PackagelineApi
{
    ...
    public function retrievePackageLineWithHttpInfo($package_line_id, $include_package_line_status, $include_package_line_type_name, $include_package_line_meta_data, $include_package_line_meta_data_objects, $include_address_object, $include_time_slots, $include_time_slot_tags, $include_route_info, $include_driver_info, $include_communication, $include_package_line_links, $include_package_lines_info, $include_package_line_files, $include_package_line_files_meta_data, $include_package_line_files_meta_data_objects)
    {
        ...
        if ($include_package_line_meta_data_objects === null) {
            throw new \InvalidArgumentException('Missing the required parameter $include_package_line_meta_data_objects when calling retrievePackageLine');
        }
        ...
        if ($include_package_line_files_meta_data_objects === null) {
            throw new \InvalidArgumentException('Missing the required parameter $include_package_line_files_meta_data_objects when calling retrievePackageLine');
        }
        // parse inputs
        $resourcePath = "/package-line/{packageLineId}";
        $httpBody = '';
        ...
        // query params
        if ($include_package_line_meta_data_objects !== null) {
            $queryParams['include_package_line_meta_data_objects'] = $this->apiClient->getSerializer()->toQueryValue($include_package_line_meta_data_objects);
        }
        // query params
        if ($include_address_object !== null) {
        ...
        // query params
        if ($include_package_line_files_meta_data_objects !== null) {
            $queryParams['include_package_line_files_meta_data_objects'] = $this->apiClient->getSerializer()->toQueryValue($include_package_line_files_meta_data_objects);
        }
        // path params
        if ($package_line_id !== null) {
            $resourcePath = str_replace(
