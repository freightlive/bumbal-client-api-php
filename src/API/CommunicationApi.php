...
class CommunicationApi
{
    ...
    /**
     * Operation retrieveMappingCommunication
     *
     * Retrieve Activity
     *
     * @param \BumbalClient\Model\CommunicationMappingRetrieveListArguments $arguments Request Arguments (required)
     * @throws \BumbalClient\ApiException on non-2xx response
     * @return \BumbalClient\Model\CommunicationMappingListResponse
     */
    public function retrieveMappingCommunication($arguments)
    {
        list($response) = $this->retrieveMappingCommunicationWithHttpInfo($arguments);
        return $response;
    }

    /**
     * Operation retrieveMappingCommunicationWithHttpInfo
     *
     * Retrieve Activity
     *
     * @param \BumbalClient\Model\CommunicationMappingRetrieveListArguments $arguments Request Arguments (required)
     ...
     */
    public function retrieveMappingCommunicationWithHttpInfo($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $arguments when calling retrieveMappingCommunication');
        }
        // parse inputs
        $resourcePath = "/communication/retrieve-mappings";
        $httpBody = '';
        $queryParams = [];
        $headerParams = [];
        $formParams = [];
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                '/communication/retrieve-mappings'
            );
