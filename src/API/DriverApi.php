...
class DriverApi
{
    ...
    public function retrieveListDriverWithHttpInfo($arguments)
    {
        ...
        try {
            ...
            return [$this->apiClient->getSerializer()->deserialize($response, '\BumbalClient\BumbalClient\Model\DriverListResponse', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\BumbalClient\BumbalClient\Model\DriverListResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
