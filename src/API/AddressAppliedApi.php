...
class AddressAppliedApi
{
    ...
    {
        $returnType = '\BumbalClient\BumbalClient\Model\AddressAppliedModel';
        $request = $this->retrieveAddressAppliedRequest($address_id);
    ...
    /**
     * Operation retrieveAddressAppliedAsync
     *
     * Retrieve an Applied Address
     *
     * @param  int $address_id ID of the applied address to retrieve (required)
     ...
     */
    public function retrieveAddressAppliedAsync($address_id)
    {
        return $this->retrieveAddressAppliedAsyncWithHttpInfo($address_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation retrieveAddressAppliedAsyncWithHttpInfo
     *
     * Retrieve an Applied Address
     *
     * @param  int $address_id ID of the applied address to retrieve (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAddressAppliedAsyncWithHttpInfo($address_id)
    {
        $returnType = '\BumbalClient\BumbalClient\Model\AddressAppliedModel';
        $request = $this->retrieveAddressAppliedRequest($address_id);
    ...
    /**
     * Create request for operation 'retrieveAddressApplied'
     *
     * @param  int $address_id ID of the applied address to retrieve (required)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function retrieveAddressAppliedRequest($address_id)
    {
        // verify the required parameter 'address_id' is set
        if ($address_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address_id when calling retrieveAddressApplied'
            );
        }
    ...
    public function updateAddressAppliedWithHttpInfo($address_id, $body = null)
    {
        ...
        $request = $this->updateAddressAppliedRequest($address_id, $body);
    ...
    /**
     * Operation updateAddressAppliedAsync
     *
     * Update a AddressApplied
     *
     * @param  int $address_id ID of address to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAddressAppliedAsync($address_id, $body = null)
    {
        return $this->updateAddressAppliedAsyncWithHttpInfo($address_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation updateAddressAppliedAsyncWithHttpInfo
     *
     * Update a AddressApplied
     *
     * @param  int $address_id ID of address to update (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateAddressAppliedAsyncWithHttpInfo($address_id, $body = null)
    {
        $returnType = '\BumbalClient\BumbalClient\Model\ApiResponse';
        $request = $this->updateAddressAppliedRequest($address_id, $body);
    ...
    /**
     * Create request for operation 'updateAddressApplied'
     *
     * @param  int $address_id ID of address to update (required)
     * @param  \BumbalClient\BumbalClient\Model\AddressAppliedModel $body AddressApplied object that needs to be updated (optional)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateAddressAppliedRequest($address_id, $body = null)
    {
        // verify the required parameter 'address_id' is set
        if ($address_id === null) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $address_id when calling updateAddressApplied'
            );
        }
