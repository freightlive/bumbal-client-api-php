...
class PlannerApi
{
    ...
    public function startAutoPlanWithHttpInfo($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $arguments when calling startAutoPlan');
        }
        // parse inputs
    ...
    public function startCheckAvailabilityWithHttpInfo($arguments)
    {
        // verify the required parameter 'arguments' is set
        if ($arguments === null) {
            throw new \InvalidArgumentException('Missing the required parameter $arguments when calling startCheckAvailability');
        }
        // parse inputs
