...
class AssignmentApi
{
     ...
     *
     * @param \Bumbal\Client\Model\AssignmentModel $body Assignment object that needs to be created (required)
     ...
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\AssignmentModel
     */
     ...
     * @param int $assignment_id ID of assignment to retrieve (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return array of \Bumbal\Client\Model\AssignmentModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveAssignmentWithHttpInfo($assignment_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Bumbal\Client\Model\AssignmentModel',
                '/assignment/{assignmentId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Bumbal\Client\Model\AssignmentModel', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Bumbal\Client\Model\AssignmentModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Bumbal\Client\Model\AssignmentRetrieveListArguments $arguments Assignment RetrieveList Arguments (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\AssignmentModel[]
     */
     ...
     *
     * @param int $assignment_id ID of assignment to update (required)
     * @param \Bumbal\Client\Model\AssignmentModel $body Assignment object that needs to be updated (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\ApiResponse
     */
