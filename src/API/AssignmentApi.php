...
class AssignmentApi
{
    ...
    public function retrieveAssignmentWithHttpInfo($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data)
    {
        ...
        $request = $this->retrieveAssignmentRequest($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAssignmentAsync($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data)
    {
        return $this->retrieveAssignmentAsyncWithHttpInfo($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function retrieveAssignmentAsyncWithHttpInfo($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data)
    {
        $returnType = '\BumbalClient\BumbalClient\Model\AssignmentModel';
        $request = $this->retrieveAssignmentRequest($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function retrieveAssignmentRequest($assignment_id, $include_assignment_links, $include_assignment_files, $include_assignment_files_meta_data)
    {
        // verify the required parameter 'assignment_id' is set
        if ($assignment_id === null) {
            throw new \InvalidArgumentException(
