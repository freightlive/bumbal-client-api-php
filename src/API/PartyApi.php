...
class PartyApi
{
     ...
     * Add a new Party
     *
     * @param \Bumbal\Client\Model\PartyModel $body Party object that needs to be created (optional)
     ...
     *
     * @param \Bumbal\Client\Model\PartyRetrieveListArguments $arguments Party RetrieveList Arguments (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\PartyModel[]
     */
     ...
     * @param \Bumbal\Client\Model\PartyRetrieveListArguments $arguments Party RetrieveList Arguments (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return array of \Bumbal\Client\Model\PartyModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveListPartyWithHttpInfo($arguments)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Bumbal\Client\Model\PartyModel[]',
                '/party'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Bumbal\Client\Model\PartyModel[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Bumbal\Client\Model\PartyModel[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
