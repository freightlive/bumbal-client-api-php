...
class AddressApi
{
     ...
     * Add a new Address
     *
     * @param \Bumbal\Client\Model\AddressModel $body Address object that needs to be created (optional)
     ...
     * @param int $address_id ID of address to retrieve (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return array of \Bumbal\Client\Model\AddressModel, HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveAddressWithHttpInfo($address_id)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Bumbal\Client\Model\AddressModel',
                '/address/{addressId}'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Bumbal\Client\Model\AddressModel', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Bumbal\Client\Model\AddressModel', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Bumbal\Client\Model\AddressRetrieveListArguments $arguments Address RetrieveList Arguments (required)
     * @throws \Bumbal\Client\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\AddressModel[]
     */
