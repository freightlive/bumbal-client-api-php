...
class TagtypeApi
{
     ...
     * Add a new Tag type
     *
     * @param \Model\TagTypeModel $body Tag type object that needs to be created (required)
     ...
     *
     * @param \Model\TagTypeRetrieveListArguments $arguments Tag types RetrieveList Arguments (required)
     * @return \Model\TagTypeModel[]
     * @throws \BumbalClient\ApiException on non-2xx response
     */
     ...
     *
     * @param \Model\TagTypeRetrieveListArguments $arguments Tag types RetrieveList Arguments (required)
     * @return Array of \Model\TagTypeModel[], HTTP status code, HTTP response headers (array of strings)
     * @throws \BumbalClient\ApiException on non-2xx response
     */
    public function retrieveListTagTypeWithHttpInfo($arguments)
    {
        ...
        try {
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\Model\TagTypeModel[]', $httpHeader), $statusCode, $httpHeader);
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Model\TagTypeModel[]', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
     ...
     *
     * @param \Model\TagTypeModel $body tag type data (optional)
     * @return \Model\ApiResponse
     * @throws \BumbalClient\ApiException on non-2xx response
     */
