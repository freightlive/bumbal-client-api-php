...
class NoteApi
{
     ...
     * Add a note
     *
     * @param \BumbalClient\Model\NoteModel $body Note object that needs to be created (optional)
     ...
     * @param \BumbalClient\Model\NoteModel $body Note object that needs to be updated (optional)
     * @throws \BumbalClient\ApiException on non-2xx response
     * @return \BumbalClient\Model\ApiResponse
     */
    ...
    public function updateNoteWithHttpInfo($note_id, $body = null)
    {
        // verify the required parameter 'note_id' is set
        if ($note_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $note_id when calling updateNote');
        }
        // parse inputs
        $resourcePath = "/note/{noteId}";
        $httpBody = '';
