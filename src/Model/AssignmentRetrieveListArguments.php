...
class AssignmentRetrieveListArguments implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        'options' => '\Model\AssignmentOptionsModel',
        'filters' => '\Model\AssignmentFiltersModel',
        'limit' => 'int',
        'offset' => 'int',
        'search_text' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("assignment.nr", "date_time_from");
    ...
    /**
     * Gets options
     * @return \Model\AssignmentOptionsModel
     */
    ...
    /**
     * Gets filters
     * @return \Model\AssignmentFiltersModel
     */
    ...
    public function setSortingColumn($sorting_column)
    {
        ...
        if (!in_array($sorting_column, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'assignment.nr', 'date_time_from'");
        }
