 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AssignmentRetrieveListArguments implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'options' => '\BumbalClient\BumbalClient\Model\AssignmentOptionsModel',
        'filters' => '\BumbalClient\BumbalClient\Model\AssignmentFiltersModel',
        'limit' => 'int',
        'offset' => 'int',
        'search_text' => 'string',
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSortingColumnAllowableValues();
        if (!in_array($this->container['sorting_column'], $allowedValues)) {
        ...
        if (!in_array($this->container['sorting_direction'], $allowedValues)) {
            $invalidProperties[] = sprintf(
     ...
     * Gets options
     *
     * @return \BumbalClient\BumbalClient\Model\AssignmentOptionsModel
     */
     ...
     * Sets options
     *
     * @param \BumbalClient\BumbalClient\Model\AssignmentOptionsModel $options options
     *
     * @return $this
     */
     ...
     * Gets filters
     *
     * @return \BumbalClient\BumbalClient\Model\AssignmentFiltersModel
     */
     ...
     * Sets filters
     *
     * @param \BumbalClient\BumbalClient\Model\AssignmentFiltersModel $filters filters
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getSortingColumnAllowableValues();
        if (!is_null($sorting_column) && !in_array($sorting_column, $allowedValues)) {
    ...
    {
        $allowedValues = $this->getSortingDirectionAllowableValues();
        if (!is_null($sorting_direction) && !in_array($sorting_direction, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'sorting_direction', must be one of '%s'",
                    implode("', '", $allowedValues)
