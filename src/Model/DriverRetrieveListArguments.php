...
class DriverRetrieveListArguments implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("id", "first_name", "last_name", "prefix", "full_name", "email");
    ...
    public function setSortingColumn($sorting_column)
    {
        ...
        if (!in_array($sorting_column, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'id', 'first_name', 'last_name', 'prefix', 'full_name', 'email'");
        }
