 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CommunicationModel implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getSaywhenStatusNameAllowableValues();
        if (!in_array($this->container['saywhen_status_name'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getSaywhenStatusNameAllowableValues();
        if (!is_null($saywhen_status_name) && !in_array($saywhen_status_name, $allowedValues)) {
