...
class PartyModel implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'created_at' => '\DateTime',
        'updated_at' => '\DateTime',
        'party_created_by_user' => '\Model\UsersModel',
        'party_updated_by_user' => '\Model\UsersModel'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['party_type_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'party_type_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('contractor', 'booking');
        if (!in_array($party_type_name, $allowed_values)) {
