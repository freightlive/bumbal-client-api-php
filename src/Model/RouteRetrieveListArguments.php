...
class RouteRetrieveListArguments implements ArrayAccess
{
    ...
    {
        $invalid_properties = [];
        $allowed_values = ["route.status_id", "date_time_from"];
        if (!in_array($this->container['sorting_column'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'sorting_column', must be one of 'route.status_id', 'date_time_from'.";
        }
    ...
    {
        $allowed_values = array('route.status_id', 'date_time_from');
        if (!is_null($sorting_column) && (!in_array($sorting_column, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'route.status_id', 'date_time_from'");
        }
