...
class RouteRetrieveListArguments implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("status_id", "date_time_from", "id", "nr", "name", "earliest_date_time", "latest_date_time");
    ...
    public function setSortingColumn($sorting_column)
    {
        ...
        if (!in_array($sorting_column, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'sorting_column', must be one of 'status_id', 'date_time_from', 'id', 'nr', 'name', 'earliest_date_time', 'latest_date_time'");
        }
