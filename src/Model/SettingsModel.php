...
class SettingsModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("general", "address", "package", "activity", "equipment", "note", "optimisation", "filters");
        if (!in_array($this->container['settings_group_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'settings_group_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('general', 'address', 'package', 'activity', 'equipment', 'note', 'optimisation', 'filters');
        if (!in_array($settings_group_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'settings_group_name', must be one of 'general', 'address', 'package', 'activity', 'equipment', 'note', 'optimisation', 'filters'");
        }
