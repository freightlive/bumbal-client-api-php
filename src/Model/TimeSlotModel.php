...
class TimeSlotModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['time_slot_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'time_slot_type', must be one of #{allowed_values}.";
        }

        $allowed_values = array("1", "2", "3");
        if (!in_array($this->container['time_slot_type_id'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'time_slot_type_id', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('1', '2', '3');
        if (!in_array($time_slot_type_id, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'time_slot_type_id', must be one of '1', '2', '3'");
        }
