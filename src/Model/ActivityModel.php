 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ActivityModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'car' => '\BumbalClient\BumbalClient\Model\CarModel',
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getActivityTypeNameAllowableValues();
        if (!in_array($this->container['activity_type_name'], $allowedValues)) {
    ...
    {
        $allowedValues = $this->getActivityTypeNameAllowableValues();
        if (!is_null($activity_type_name) && !in_array($activity_type_name, $allowedValues)) {
