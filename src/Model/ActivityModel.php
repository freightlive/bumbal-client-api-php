...
class ActivityModel implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'address_applied' => '\Model\AddressAppliedModel',
        'depot_address' => '\Model\AddressModel',
        'depot_address_id' => 'int',
        'allowed_driver_ids' => 'int[]',
        'allowed_drivers' => 'object',
        'allowed_drivers_links' => '\Model\LinkModel[]',
        'applied_capacities' => 'object',
        'capacities' => '\Model\CapacityModel[]',
        'package_lines' => '\Model\PackageLineModel[]',
        'time_slots' => '\Model\TimeSlotModel[]',
        'brand_id' => 'int',
        'brand' => '\Model\BrandModel',
        'communication' => '\Model\CommunicationModel',
        'assignment_link' => '\Model\LinkModel',
        'route_link' => '\Model\LinkModel',
        ...
        'activity_created_by_user' => '\Model\UsersModel',
        'activity_updated_by_user' => '\Model\UsersModel'
    );
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['activity_type_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'activity_type_name', must be one of #{allowed_values}.";
        }
        ...
        if (!in_array($this->container['activity_type_id'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'activity_type_id', must be one of #{allowed_values}.";
        }

        $allowed_values = array("activity_incomplete", "activity_new", "activity_accepted", "activity_planned", "activity_in_progress", "activity_executed", "activity_cancelled", "activity_awaiting");
        if (!in_array($this->container['status_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('1', '2', '3', '4', '5', '6', '9', '10', '11', '13', '14', '15', '16', '17', '18', '19', '20', '21', '26', '27', '28', '29', '30', '31', '32');
        if (!in_array($activity_type_id, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'activity_type_id', must be one of '1', '2', '3', '4', '5', '6', '9', '10', '11', '13', '14', '15', '16', '17', '18', '19', '20', '21', '26', '27', '28', '29', '30', '31', '32'");
        }
    ...
    {
        $allowed_values = array('activity_incomplete', 'activity_new', 'activity_accepted', 'activity_planned', 'activity_in_progress', 'activity_executed', 'activity_cancelled', 'activity_awaiting');
        if (!in_array($status_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'status_name', must be one of 'activity_incomplete', 'activity_new', 'activity_accepted', 'activity_planned', 'activity_in_progress', 'activity_executed', 'activity_cancelled', 'activity_awaiting'");
        }
    ...
    /**
     * Gets communication
     * @return \Model\CommunicationModel
     */
