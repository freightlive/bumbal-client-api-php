...
class ActivityModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = ["activity_incomplete", "activity_new", "activity_accepted", "activity_planned", "activity_in_progress", "activity_executed", "activity_cancelled", "activity_awaiting"];
        if (!in_array($this->container['status_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'status_name', must be one of 'activity_incomplete', 'activity_new', 'activity_accepted', 'activity_planned', 'activity_in_progress', 'activity_executed', 'activity_cancelled', 'activity_awaiting'.";
        }
