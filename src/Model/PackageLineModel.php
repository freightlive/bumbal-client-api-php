...
class PackageLineModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['action_type_id'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'action_type_id', must be one of #{allowed_values}.";
        }

        $allowed_values = array("inbound", "outbound", "assess");
        if (!in_array($this->container['action_type_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'action_type_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('1', '2', '3');
        if (!in_array($action_type_id, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'action_type_id', must be one of '1', '2', '3'");
        }
    ...
    {
        $allowed_values = array('inbound', 'outbound', 'assess');
        if (!in_array($action_type_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'action_type_name', must be one of 'inbound', 'outbound', 'assess'");
        }
