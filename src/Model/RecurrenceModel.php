...
class RecurrenceModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("activity", "route");
        if (!in_array($this->container['recurrence_type_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'recurrence_type_name', must be one of #{allowed_values}.";
        }

        $allowed_values = array("day", "week", "month");
        if (!in_array($this->container['recurrence_period_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'recurrence_period_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('activity', 'route');
        if (!in_array($recurrence_type_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'recurrence_type_name', must be one of 'activity', 'route'");
        }
    ...
    {
        $allowed_values = array('day', 'week', 'month');
        if (!in_array($recurrence_period_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'recurrence_period_name', must be one of 'day', 'week', 'month'");
        }
