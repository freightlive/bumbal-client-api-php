...
class PhoneNrModel implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("mobile", "landline", "fax");
        if (!in_array($this->container['phone_nr_type_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'phone_nr_type_name', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('mobile', 'landline', 'fax');
        if (!in_array($phone_nr_type_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'phone_nr_type_name', must be one of 'mobile', 'landline', 'fax'");
        }
