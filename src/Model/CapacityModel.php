...
class CapacityModel implements ArrayAccess
{
    ...
    protected static $swaggerTypes = array(
        ...
        'capacity_type' => '\Model\CapacityTypeModel',
        'capacity_value' => 'double',
        'unit_values' => '\Model\UnitValueModel[]',
    ...
    public function listInvalidProperties()
    {
        ...
        $allowed_values = array("CM", "M", "MI", "CM3", "M3", "LI", "KG", "PD", "amount", "MM", "MM3", "DM", "DM3", "G", "MG", "CG", "DG");
        if (!in_array($this->container['capacity_value_uom_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'capacity_value_uom_name', must be one of #{allowed_values}.";
        }

        $allowed_values = array("CM", "M", "MI", "CM3", "M3", "LI", "KG", "PD", "amount", "MM", "MM3", "DM", "DM3", "G", "MG", "CG", "DG");
        if (!in_array($this->container['unit_values_uom_name'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'unit_values_uom_name', must be one of #{allowed_values}.";
        }
    ...
    /**
     * Sets capacity_type
     * @param \Model\CapacityTypeModel $capacity_type 
     * @return $this
     */
    ...
    /**
     * Sets unit_values
     * @param \Model\UnitValueModel[] $unit_values 
     * @return $this
     */
    ...
    {
        $allowed_values = array('CM', 'M', 'MI', 'CM3', 'M3', 'LI', 'KG', 'PD', 'amount', 'MM', 'MM3', 'DM', 'DM3', 'G', 'MG', 'CG', 'DG');
        if (!in_array($capacity_value_uom_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'capacity_value_uom_name', must be one of 'CM', 'M', 'MI', 'CM3', 'M3', 'LI', 'KG', 'PD', 'amount', 'MM', 'MM3', 'DM', 'DM3', 'G', 'MG', 'CG', 'DG'");
        }
    ...
    {
        $allowed_values = array('CM', 'M', 'MI', 'CM3', 'M3', 'LI', 'KG', 'PD', 'amount', 'MM', 'MM3', 'DM', 'DM3', 'G', 'MG', 'CG', 'DG');
        if (!in_array($unit_values_uom_name, $allowed_values)) {
            throw new \InvalidArgumentException("Invalid value for 'unit_values_uom_name', must be one of 'CM', 'M', 'MI', 'CM3', 'M3', 'LI', 'KG', 'PD', 'amount', 'MM', 'MM3', 'DM', 'DM3', 'G', 'MG', 'CG', 'DG'");
        }
