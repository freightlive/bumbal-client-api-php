...
class SettingsApi
{
     ...
     *
     * @param \Bumbal\Client\Model\SettingsRetrieveListArguments $arguments Settings RetrieveList Arguments (required)
     * @throws \BumbalClient\ApiException on non-2xx response
     * @return \Bumbal\Client\Model\SettingsModel[]
     */
     ...
     * @param \Bumbal\Client\Model\SettingsRetrieveListArguments $arguments Settings RetrieveList Arguments (required)
     * @throws \BumbalClient\ApiException on non-2xx response
     * @return array of \Bumbal\Client\Model\SettingsModel[], HTTP status code, HTTP response headers (array of strings)
     */
    public function retrieveListSettingsWithHttpInfo($arguments)
    {
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                ...
                $httpBody,
                $headerParams,
                '\Bumbal\Client\Model\SettingsModel[]',
                '/settings'
            );

            return [$this->apiClient->getSerializer()->deserialize($response, '\Bumbal\Client\Model\SettingsModel[]', $httpHeader), $statusCode, $httpHeader];
        } catch (ApiException $e) {
            switch ($e->getCode()) {
                case 200:
                    $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\Bumbal\Client\Model\SettingsModel[]', $e->getResponseHeaders());
